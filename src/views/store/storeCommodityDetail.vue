  ...
  <div class="app-container">
    ...
    <div class="centent">
      <div class="cententTop">
        ...
        <div class="left">
          <div class="leftTitlle">所属店铺:</div>
          <div class="rightCenten">{{data.storeName}}</div>
        </div>
        <div class="left">
        ...
        <div class="left">
          ...
          <div class="rightCenten" v-for="item,index in data.optionalList" :key="index">
            {{item.name}}:
...
export default {
  ...
  created() {
    sysStoreOrderingGoodsDetails(this.$route.query.id).then(res => {
      this.data = res.data
      this.data.enable == 1
